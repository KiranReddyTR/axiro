...
export default function WhyUsSection() {
  return (
    <section className="py-24 bg-gradient-to-br from-slate-950 via-violet-950 to-slate-900 overflow-hidden relative">
      {/* Background elements */}
      <div className="hero-grid absolute inset-0 opacity-20 pointer-events-none" />
      <div className="absolute top-0 right-0 w-96 h-96 orb-violet opacity-40 pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-72 h-72 orb-cyan opacity-30 pointer-events-none" />

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="max-w-3xl mx-auto text-center mb-16 reveal">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-violet-500/10 border border-violet-400/20 rounded-full text-violet-300 text-sm font-semibold uppercase tracking-wider mb-6">
            Why Choose Axiro
          </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 mb-16">
          {achievements.map((a, i) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 bg-gradient-to-br from-violet-500 to-cyan-500 rounded-xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                  <Icon className="w-6 h-6 text-white" />
                </div>
                <div className="text-2xl md:text-3xl font-bold font-poppins bg-gradient-to-r from-violet-400 to-cyan-300 bg-clip-text text-transparent mb-1">
                  {a.number}
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-12">
          ...
          {/* CTA card */}
          <div className="reveal delay-6 relative bg-gradient-to-br from-violet-500 to-cyan-500 rounded-2xl p-6 flex flex-col justify-between overflow-hidden">
            ...
            <Link
              to="/careers"
              className="mt-4 inline-flex items-center gap-2 bg-white text-violet-600 font-semibold text-sm px-4 py-2 rounded-xl hover:bg-gray-100 transition-colors w-fit"
            >
        ...
        <div className="text-center reveal">
          <Link to="/about" className="inline-flex items-center gap-2 px-7 py-3.5 bg-gradient-to-r from-violet-500 to-cyan-500 text-white font-semibold rounded-xl hover:shadow-2xl hover:shadow-violet-500/40 hover:scale-105 transition-all duration-300">
